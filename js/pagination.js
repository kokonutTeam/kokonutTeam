...
function nextPage2() {
    ...
    setTimeout(() => {
        ...
        $(".page_in_4").css("background-image", "url('./img/back_P_4.jpg')");
    }, 900);
    ml10();
...
function nextPage3() {
    ...
    setTimeout(() => {
        ...
        $(".page_in").css("background-image", "url('./img/back_P_5_1.jpg')");
    }, 900);
    setTimeout(function() {
...
function nextPage4() {
    ...
    setTimeout(() => {
        ...
        $(".page_in_2 ").children().css("visibility", "hidden");
        $(".page_in_2").css("background-image", "url('./img/back_P_2.jpg')");
